    ...
    <figure>
      <table>
        <tbody>
          <tr>
            <td
              ><a href="#" on:click={(event) => event.preventDefault()}>Link</a
              ></td
            >
...
<footer class="container">
  <small>
    Built by <a href="https://github.com/HyperAlch/">HyperAlch</a> •
    <a href="#">GitHub</a> •
    <a href="https://github.com/chsami/microbot">Microbot</a>
  </small>
</footer>
